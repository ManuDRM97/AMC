...
${OBJECTDIR}/_ext/79bede10/AlgoritmosBusqueda.o: /G/3TERCERO/Algoritmos/Practica1_AMC/AlgoritmosBusqueda.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/79bede10/AlgoritmosBusqueda.o /G/3TERCERO/Algoritmos/Practica1_AMC/AlgoritmosBusqueda.cpp

${OBJECTDIR}/_ext/79bede10/AlgoritmosOrdenacion.o: /G/3TERCERO/Algoritmos/Practica1_AMC/AlgoritmosOrdenacion.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/79bede10
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/79bede10/AlgoritmosOrdenacion.o /G/3TERCERO/Algoritmos/Practica1_AMC/AlgoritmosOrdenacion.cpp

${OBJECTDIR}/_ext/79bede10/AnalisisAlgoritmos.o: /G/3TERCERO/Algoritmos/Practica1_AMC/AnalisisAlgoritmos.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/79bede10
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/79bede10/AnalisisAlgoritmos.o /G/3TERCERO/Algoritmos/Practica1_AMC/AnalisisAlgoritmos.cpp

${OBJECTDIR}/_ext/79bede10/ConjuntoInt.o: /G/3TERCERO/Algoritmos/Practica1_AMC/ConjuntoInt.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/79bede10
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/79bede10/ConjuntoInt.o /G/3TERCERO/Algoritmos/Practica1_AMC/ConjuntoInt.cpp

${OBJECTDIR}/_ext/79bede10/Graficas.o: /G/3TERCERO/Algoritmos/Practica1_AMC/Graficas.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/79bede10
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/79bede10/Graficas.o /G/3TERCERO/Algoritmos/Practica1_AMC/Graficas.cpp

${OBJECTDIR}/_ext/79bede10/Mtime.o: /G/3TERCERO/Algoritmos/Practica1_AMC/Mtime.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/79bede10
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/79bede10/Mtime.o /G/3TERCERO/Algoritmos/Practica1_AMC/Mtime.cpp

${OBJECTDIR}/_ext/79bede10/TestBusqueda.o: /G/3TERCERO/Algoritmos/Practica1_AMC/TestBusqueda.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/79bede10
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/79bede10/TestBusqueda.o /G/3TERCERO/Algoritmos/Practica1_AMC/TestBusqueda.cpp

${OBJECTDIR}/_ext/79bede10/TestOrdenacion.o: /G/3TERCERO/Algoritmos/Practica1_AMC/TestOrdenacion.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/79bede10
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/79bede10/TestOrdenacion.o /G/3TERCERO/Algoritmos/Practica1_AMC/TestOrdenacion.cpp
